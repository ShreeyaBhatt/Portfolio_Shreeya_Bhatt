...
const CYAN = "#9b8cff"; /* violet — home is the violet Command Deck */
const VIOLET = "#5b8dff"; /* cosmic blue ring — counterpoint to the violet body */
...
function Scene({ pointer }) {
  return (
    <>
      ...
      <directionalLight position={[3, 4, 5]} intensity={2.2} color="#eef0ff" />
